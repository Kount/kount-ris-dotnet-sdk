namespace KountRisSdk.Kount.SimpleLogger
{
    using System;
    ...
    public class File
    {
        ...
        public File(string name)
        {
            ...
            // Supporing both relative and absolute path
            this.logFilePath = new Uri(Path.Combine(logPath, logFile), UriKind.Relative).OriginalString;
        }
